...
const paths = {
  ...
  dist: {
    ...
    js: {
      ...
      backend: './dist/assets/js/backend',
      frontend: './dist/assets/js/frontend'
    },
  },
  src: {
    base: {
...
gulp.task('watch', function () {
  ...
  gulp.watch([paths.src.js.dir], gulp.series(['js', 'jsPages'], 'browsersyncReload'));
...
gulp.task('jsPages', function () {
  gulp
    .src(paths.src.js.backend)
    .pipe(uglify())
    .pipe(gulp.dest(paths.dist.js.backend));

  gulp
    .src(paths.src.js.frontend)
    .pipe(uglify())
    .pipe(gulp.dest(paths.dist.js.frontend));
