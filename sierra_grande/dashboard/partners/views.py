...
class PartnerCreateView(SuccessMessageMixin, generic.CreateView):
    model = Partner
    template_name = "oscar/dashboard/partners/partner_form.html"
    form_class = PartnerCreateForm
    success_url = reverse_lazy("dashboard:partner-list")
    success_message = _('Partner "%s" was created successfully.')
    ...
    def get_success_message(self, cleaned_data):
        """
        Override the default success message to include the partner name.
        """
        return self.success_message % cleaned_data["name"]


class PartnerManageView(SuccessMessageMixin, generic.UpdateView):
    """
    ...
    success_url = reverse_lazy("dashboard:partner-list")
    success_message = _('Partner "%s" was updated successfully.')
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["partner_name"] = self.partner.name
...
class PartnerUserCreateView(SuccessMessageMixin, generic.CreateView):
    model = User
...
class PartnerUserSelectView(generic.ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if "email" in request.GET:
            data = request.GET
        self.form = self.form_class(data, partner=self.partner)
