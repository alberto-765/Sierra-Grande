...
const values = [
    {
        ...
        label: '<img src="../static/img/ecommerce/payment/american-express.png" class="avatar-xxs me-1"/> American Express',
        id: 1
    },
    {
        value: 'PayPal',
        label: '<img src="../static/img/ecommerce/payment/paypal.png" class="avatar-xxs me-1"/> American PayPal',
        id: 2
    },
    {
        value: 'Discover',
        label: '<img src="../static/img/ecommerce/payment/discover.png" class="avatar-xxs me-1"/> Discover',
        id: 3
    },
    {
        value: 'Visa Credit/Debit',
        label: '<img src="../static/img/ecommerce/payment/visa.png" class="avatar-xxs me-1"/> Visa Credit/Debit',
        id: 4
    }
];
    ...
    switch (value) {
        case "American Express":
            return (
                `<div class="d-flex align-items-center gap-2">
                    <div class="flex-shrink-0">
                        <img src="../static/img/ecommerce/payment/american-express.png" alt="" class="avatar-xs object-fit-cover paycard-image">
                    </div>
                    <div class="flex-grow-1">
        ...
        case "PayPal":
            return (
                `<div class="d-flex align-items-center gap-2">
                    <div class="flex-shrink-0">
                        <img src="../static/img/ecommerce/payment/paypal.png" alt="" class="avatar-xs object-fit-cover paycard-image">
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-0 paycard">${ value }</h6>
                    </div>
        ...
        case "Discover":
            return (
                `<div class="d-flex align-items-center gap-2">
                    <div class="flex-shrink-0">
                        <img src="../static/img/ecommerce/payment/discover.png" alt="" class="avatar-xs object-fit-cover paycard-image">
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-0 paycard">${ value }</h6>
                    </div>
        ...
        case "Visa Credit/Debit":
            return (
                `<div class="d-flex align-items-center gap-2">
                    <div class="flex-shrink-0">
                        <img src="../static/img/ecommerce/payment/visa.png" alt="" class="avatar-xs object-fit-cover paycard-image">
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-0 paycard">${ value }</h6>
                    </div>
